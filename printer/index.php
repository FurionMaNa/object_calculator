...
<div class="container">
        ...
        <div class="col-12">
            <table class="table table-striped table-bordered">
                ...
                <tr class="table-primary">
                    ...
                    <td><?php echo money_format('%.2n',((intval($_GET['shetpon'])*16800)+(intval($_GET['gangway'])*9460)+(intval($_GET['connector'])*280)+(intval($_GET['stairs'])*18560)+(intval($_GET['stays'])*890)+(intval($_GET['bench'])*12500)+(intval($_GET['duck'])*1250)));?></td>
                </tr>
    ...
    <center><a data-fancybox="gallery" href=<?php echo $_GET['screen'];?>><img  width=600px src=<?php echo $_GET['screen'];?>></a></center>
</div>
